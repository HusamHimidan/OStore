        ...
        private class MainShellPageFlyoutViewModel : INotifyPropertyChanged
        {
            ...
            public MainShellPageFlyoutViewModel()
            {
                MenuItems = new ObservableCollection<MainShellPageFlyoutMenuItem>(new[]
                {
                    ...
                    {
                        Id = 1,
                        Tag=new ViewModels.ProductViewModel(new Category() {Id=1}),
                        Title = "Boots",
                        TargetType=typeof(Views.ProductsPage)
                    ...
                    { 
                        Id = 2,
                        Tag=new ViewModels.ProductViewModel(new Category() {Id=2}),
                        Title = "Shirts",
                        TargetType=typeof(Views.ProductsPage)
                    },
                     ...
                     { 
                         Id = 3,
                         Tag=new ViewModels.ProductViewModel(new Category(){ Id=3}),
                         Title = "Jacket",
                         TargetType=typeof(Views.ProductsPage)
                    },
                     ...
                     { 
                         Id = 4,
                         Tag=new ViewModels.ProductViewModel(new Category(){Id=4}),
